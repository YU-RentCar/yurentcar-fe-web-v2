...
const Pay = () => {
  ...
  return (
    <div className="w-[300px] h-[360px] rounded-2xl fixed top-[576px] right-[390px] bg-sky-50 shadow-figma flex flex-col items-center">
      ...
      <div className="w-[280px] h-[300px] flex justify-between items-center mt-4">
        ...
        <div className="flex flex-col items-center justify-around w-full h-full px-4 py-4 bg-white rounded-2xl">
          <div className="w-full h-[35px] flex justify-between items-center">
            <span className="text-xl font-bold">할인 전</span>
            <span className="text-xl font-bold line-through">
              {rentInfo.beforePrice}원
            </span>
          </div>
          <div className="w-full h-[35px] flex justify-between items-center">
            <span className="text-xl font-bold">할인 후</span>
            <span className="text-xl font-bold text-red-500">
              {rentInfo.afterPrice}원
            </span>
          </div>
          <div className="w-full h-[35px] flex justify-between items-center">
            <span className="text-xl font-bold">보험료</span>
            <span className="text-xl font-bold text-blue-600">
              +{rentInfo.insurance < 0 ? 0 : rentInfo.insurance}원
            </span>
          </div>
          <div className="w-full h-[35px] flex justify-between items-center">
            <span className="text-xl font-bold">포인트</span>
            <span className="text-xl font-bold text-red-500">
          ...
          <div className="w-full h-[35px] flex justify-between items-center">
            <span className="text-xl font-bold">결제금액</span>
            <span className="text-xl font-bold text-blue-600">
              {rentInfo.afterPrice +
        ...
        {/* 최종 결제 버튼 */}
        <button
          className="flex items-center justify-center w-full h-12 text-2xl font-bold rounded-lg bg-amber-400 hover:shadow-figma"
          onClick={() => {
